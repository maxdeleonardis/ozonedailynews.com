...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/apple/news/apple-march-2026-products-macbook-iphone-17e-ipad-air-m5',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/apple/news/apple-march-2026-products-macbook-iphone-17e-ipad-air-m5',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/apple/apple-march-2026-products-macbook-iphone-17e-event.jpg'],
...
export default function AppleMarch2026ProductsPage() {
  return <WikiArticle slug="apple-news-apple-march-2026-products-macbook-iphone-17e-ipad-air-m5" />;
}
