        ...
        <article className="prose prose-lg max-w-none">
          <div className="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Serge Gatari, AI expert and infamous guru, is launching a new program—an AI Community 
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Serge Gatari has built a reputation in the AI education space, positioning himself 
