...
export const metadata: Metadata = {
  title: 'Conan Boyle â€” Science & Technology Writer | ObjectWire',
  description:
  ...
  twitter: {
    card: 'summary',
    title: 'Conan Boyle â€” Science & Technology Writer',
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="bg-gray-900 text-white border-b border-gray-800">
        <div className="max-w-5xl mx-auto px-6 py-5 flex flex-wrap items-center gap-6 text-xs font-mono text-gray-400">
          ...
          <span>ðŸŽ“ NC State University â€” Journalism</span>
          ...
          <aside className="lg:col-span-4 space-y-7">
            ...
            <div className="border border-gray-200 divide-y divide-gray-100">
              {[
                ...
                ['Education', 'NC State â€” Journalism'],
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-[15px]">
                <p>
                  ...
                  brings a research-grounded perspective to complex scientific topics â€” translating
                ...
                <p>
                  ...
                  startups challenging NVIDIA&rsquo;s data center dominance â€” including a deep-dive
                ...
                <p>
                  ...
                  written extensively on Nintendo&rsquo;s Switch 2 ecosystem â€” including the technical
                  breakdown of Donkey Kong Bananza&rsquo;s 347-million-voxel destruction engine
                  revealed at GDC 2026 â€” as well as PokÃ©mon Pokopia&rsquo;s record-breaking 2.2 million
            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  {
                    label: 'Donkey Kong Bananza â€” 347M Voxels',
                  ...
                  {
                    label: 'PokÃ©mon Pokopia â€” 2.2M Copies in 4 Days',
                    detail: 'Switch 2 launch record â€” Nintendo stock +15%, Japan accounting for nearly 1M of the first-week units.',
                    href: '/video-games/nintendo/pokemon-pokopia-2-million-copies-4-days-switch-2',
                    date: 'March 12, 2026',
                  },
                  {
                    label: 'Neurophos â€” Photonic AI Chip Startup',
