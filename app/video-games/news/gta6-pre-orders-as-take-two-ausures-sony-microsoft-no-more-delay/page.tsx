...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/news/gta6-pre-orders-as-take-two-ausures-sony-microsoft-no-more-delay',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/news/gta6-pre-orders-as-take-two-ausures-sony-microsoft-no-more-delay',
    siteName: 'ObjectWire',
...
export default function GTA6PreOrdersPage() {
  return <WikiArticle slug="video-games-news-gta6-pre-orders-as-take-two-ausures-sony-microsoft-no-more-delay" />;
}
