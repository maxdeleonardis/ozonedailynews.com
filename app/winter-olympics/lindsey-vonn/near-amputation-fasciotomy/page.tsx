...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/winter-olympics/lindsey-vonn/near-amputation-fasciotomy',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/winter-olympics/lindsey-vonn/near-amputation-fasciotomy',
    siteName: 'ObjectWire',
...
export default function VonnNearAmputationPage() {
  return <WikiArticle slug="winter-olympics-lindsey-vonn-near-amputation-fasciotomy" />;
}
