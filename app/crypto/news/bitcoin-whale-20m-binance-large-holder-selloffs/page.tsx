...
export const metadata: Metadata = {
  ...
  description: 'A Bitcoin whale transferred 300 BTC worth $20.6M to Binance on Monday, sitting on a 30% unrealized loss. The move follows a wave of large-holder',
  keywords: [
  ...
  openGraph: {
    title: 'Bitcoin Whale Moves $20M to Binance Amid Large-Holder',
