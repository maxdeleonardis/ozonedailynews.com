...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/amazon/news/andy-jassy-ai-will-reduce-headcount-many-roles-cnbc-february-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/amazon/news/andy-jassy-ai-will-reduce-headcount-many-roles-cnbc-february-2026',
    siteName: 'ObjectWire',
    images: ['/images/andy-jassy-ai-workforce.jpg'],
...
export default function JassyAIWorkforcePage() {
  return <WikiArticle slug="amazon-news-andy-jassy-ai-will-reduce-headcount-many-roles-cnbc-february-2026" />;
}
