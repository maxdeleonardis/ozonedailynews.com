          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-xl border border-gray-200 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* KSI */}
                <Link href="/youtube/sidemen/ksi" className="group block border-2 border-red-200 rounded-lg p-6 hover:border-red-500 hover:shadow-lg transition-all">
                ...
                {/* Miniminter */}
                <Link href="/youtube/sidemen/miniminter" className="group block border-2 border-blue-200 rounded-lg p-6 hover:border-blue-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
                ...
                {/* Zerkaa */}
                <Link href="/youtube/sidemen/zerkaa" className="group block border-2 border-purple-200 rounded-lg p-6 hover:border-purple-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
                ...
                {/* TBJZL */}
                <Link href="/youtube/sidemen/tbjzl" className="group block border-2 border-green-200 rounded-lg p-6 hover:border-green-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
                ...
                {/* Behzinga */}
                <Link href="/youtube/sidemen/behzinga" className="group block border-2 border-orange-200 rounded-lg p-6 hover:border-orange-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
                ...
                {/* Vikkstar123 */}
                <Link href="/youtube/sidemen/vikkstar" className="group block border-2 border-yellow-200 rounded-lg p-6 hover:border-yellow-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
                ...
                {/* W2S */}
                <Link href="/youtube/sidemen/w2s" className="group block border-2 border-pink-200 rounded-lg p-6 hover:border-pink-500 hover:shadow-lg transition-all">
                  <div className="flex items-start justify-between mb-3">
        ...
        <div className="container mx-auto px-4 py-12 max-w-7xl">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <Link href="/youtube/sidemen/ksi" className="bg-red-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-red-700 transition-colors">
                KSI
              </Link>
              <Link href="/youtube/sidemen/miniminter" className="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                Miniminter
              </Link>
              <Link href="/youtube/sidemen/zerkaa" className="bg-purple-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
                Zerkaa
              </Link>
              <Link href="/youtube/sidemen/tbjzl" className="bg-green-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-green-700 transition-colors">
                TBJZL
              </Link>
              <Link href="/youtube/sidemen/behzinga" className="bg-orange-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-orange-700 transition-colors">
                Behzinga
              </Link>
              <Link href="/youtube/sidemen/vikkstar" className="bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-yellow-700 transition-colors">
                Vikkstar123
              </Link>
              <Link href="/youtube/sidemen/w2s" className="bg-pink-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-pink-700 transition-colors">
                W2S
              </Link>
            </div>
          </div>
