...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/earth/news/who-owns-the-ocean-floor',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/earth/news/who-owns-the-ocean-floor',
    siteName: 'ObjectWire',
...
export default function WhoOwnsOceanFloorPage() {
  return <WikiArticle slug="earth-news-who-owns-the-ocean-floor" />;
}
