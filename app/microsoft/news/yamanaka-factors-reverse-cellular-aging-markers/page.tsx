...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/microsoft/news/yamanaka-factors-reverse-cellular-aging-markers',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/microsoft/news/yamanaka-factors-reverse-cellular-aging-markers',
    siteName: 'ObjectWire',
...
export default function YamanakaFactorsPage() {
  return <WikiArticle slug="microsoft-news-yamanaka-factors-reverse-cellular-aging-markers" />;
}
