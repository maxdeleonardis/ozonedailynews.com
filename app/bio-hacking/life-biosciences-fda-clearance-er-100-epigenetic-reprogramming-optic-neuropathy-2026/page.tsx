...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/bio-hacking/life-biosciences-fda-clearance-er-100-epigenetic-reprogramming-optic-neuropathy-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/bio-hacking/life-biosciences-fda-clearance-er-100-epigenetic-reprogramming-optic-neuropathy-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/bio-hacking/life-biosciences-er100-fda-clearance.jpg'],
...
export default function LifeBiosciencesER100Page() {
  return <WikiArticle slug="bio-hacking-life-biosciences-fda-clearance-er-100-epigenetic-reprogramming-optic-neuropathy-2026" />;
}
