...
const SLUG = '/influencer/mika-lafuente';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    section: 'Influencer',
    tags: ['Mika Lafuente', 'Influencer', 'Model', 'Bryce Hall', 'Instagram', 'Argentina'],
...
export default function InfluencerMikaLafuentePage() {
