...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/Digital-Foundry',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/Digital-Foundry',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/video-games/crimson-desert-blackspace-engine-4k-60fps-ray-tracing-digital-foundry-2026.jpg'],
...
export default function CrimsonDesertDigitalFoundryPage() {
  return <WikiArticle slug="video-games-Digital-Foundry" />;
}
