...
export const metadata: Metadata = {
  ...
  description: 'Breaking news, investigative reports, and in-depth analysis from OzoneNews.',
...
export default async function Page() {
  ...
  const articles = all
    .filter((e) => {
      const slugMatch = e.slug.startsWith('/news/');
      const catMatch = ['News', 'news'].some(
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 text-base sm:text-lg max-w-2xl">
                Breaking stories, investigations, and in-depth analysis.
              </p>
            </div>
          </div>
        </div>
