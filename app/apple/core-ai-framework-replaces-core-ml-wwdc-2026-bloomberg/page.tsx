...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/apple/core-ai-framework-replaces-core-ml-wwdc-2026-bloomberg',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/apple/core-ai-framework-replaces-core-ml-wwdc-2026-bloomberg',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/apple/apple-core-ai-framework-wwdc-2026-core-ml-replacement.jpg'],
...
export default function AppleCoreAIWWDC2026Page() {
  return <WikiArticle slug="apple-core-ai-framework-replaces-core-ml-wwdc-2026-bloomberg" />;
}
