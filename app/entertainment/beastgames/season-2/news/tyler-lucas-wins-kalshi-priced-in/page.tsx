...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/entertainment/beastgames/season-2/news/tyler-lucas-wins-kalshi-priced-in',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/entertainment/beastgames/season-2/news/tyler-lucas-wins-kalshi-priced-in',
    siteName: 'ObjectWire',
...
export default function TylerLucasKalshiArticlePage() {
  return <WikiArticle slug="entertainment-beastgames-season-2-news-tyler-lucas-wins-kalshi-priced-in" />;
}
