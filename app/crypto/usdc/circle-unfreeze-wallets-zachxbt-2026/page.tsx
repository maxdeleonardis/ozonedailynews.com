...
export const metadata: Metadata = {
  ...
  description:
    'Circle unfroze 5 of 16 blacklisted USDC hot wallets after blockchain investigator ZachXBT exposed the sealed court-order freeze, as Circle stock fell ~20%',
  keywords: [
  ...
  openGraph: {
    ...
    title: 'Circle Unfreeze 5 of 16 USDC Wallets After ZachXBT Backlash',
    description:
      'Circle Internet Group unfroze five of 16 blacklisted USDC business hot wallets after blockchain investigator ZachXBT exposed the sealed court-order',
