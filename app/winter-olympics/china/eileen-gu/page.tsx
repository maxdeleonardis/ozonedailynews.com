...
export const metadata: Metadata = {
  title: 'Eileen Gu | Chinese Freestyle Skiing Star Profile | Milan',
  description: 'Profile of Eileen Gu, the freestyle skiing sensation who won slopestyle silver on February 9, 2026, her fourth career Olympic medal, with halfpipe and big',
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/winter-olympics/china/eileen-gu',
  },
};
