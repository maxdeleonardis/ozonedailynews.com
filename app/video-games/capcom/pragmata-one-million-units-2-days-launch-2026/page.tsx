...
export const metadata: Metadata = {
  ...
  description: 'Capcom\'s Pragmata sold over one million copies in its first 48 hours, breaking the new IP curse. Switch 2 port praised, Capcom stock jumped 3.2% at',
  keywords: [
    'Pragmata sales',
