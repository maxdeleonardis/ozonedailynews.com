...
export default async function Page() {
  ...
  const articles = all
    .filter((e) => {
      const slugMatch = e.slug.startsWith("/events/");
      const catMatch = e.category.toLowerCase() === "events" || e.category.toLowerCase() === "events" || e.category.toLowerCase() === "tech";
      ...
      <header className="border-b-2 border-black bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-black">Events</h1>
              <p className="mt-2 text-gray-600 text-base sm:text-lg max-w-2xl">Latest tech event news: GDC, GTC, Davos, CES and major industry conference coverage.</p>
            </div>
          </div>
        </div>
      </header>
