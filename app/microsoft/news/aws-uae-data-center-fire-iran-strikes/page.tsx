...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/microsoft/news/aws-uae-data-center-fire-iran-strikes' },
  openGraph: {
    ...
    type: 'article', url: 'https://www.objectwire.org/microsoft/news/aws-uae-data-center-fire-iran-strikes', siteName: 'ObjectWire',
...
export default function AWSUAEDataCenterPage() {
  return <WikiArticle slug="microsoft-news-aws-uae-data-center-fire-iran-strikes" />;
}
