...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/technology/grok-xai-pentagon-classified-approval-federal-safety-warnings-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/technology/grok-xai-pentagon-classified-approval-federal-safety-warnings-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/technology/grok-pentagon-federal-safety-2026.jpg'],
...
export default function GrokPentagonApprovalBriefPage() {
  return <WikiArticle slug="technology-grok-xai-pentagon-classified-approval-federal-safety-warnings-2026" />;
}
