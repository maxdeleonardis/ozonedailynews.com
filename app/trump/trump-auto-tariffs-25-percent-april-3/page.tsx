...
export const metadata: Metadata = {
  ...
  description:
    'President Trump signed an executive order imposing 25% tariffs on all imported automobiles and auto parts, effective April 3. Analysts project a $3,000 to $10,000 price increase on foreign-built vehicles.',
  keywords: [
