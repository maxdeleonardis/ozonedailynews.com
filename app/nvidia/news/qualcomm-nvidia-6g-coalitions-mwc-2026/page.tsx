...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/nvidia/news/qualcomm-nvidia-6g-coalitions-mwc-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/nvidia/news/qualcomm-nvidia-6g-coalitions-mwc-2026',
    siteName: 'ObjectWire',
...
export default function QualcommNvidia6GMWCPage() {
  return <WikiArticle slug="nvidia-news-qualcomm-nvidia-6g-coalitions-mwc-2026" />;
}
