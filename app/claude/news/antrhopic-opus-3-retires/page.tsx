...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/claude/news/antrhopic-opus-3-retires',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/claude/news/antrhopic-opus-3-retires',
    siteName: 'ObjectWire',
...
export default function AnthropicOpus3RetiresPage() {
  return <WikiArticle slug="claude-news-antrhopic-opus-3-retires" />;
}
