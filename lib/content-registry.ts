// =============================================================================
// CONTENT REGISTRY — OzoneNews Central Content Metadata
// =============================================================================
...
export const contentRegistry: ContentEntry[] = [
  ...
  // --- Auto-added by wiki:publish 2026-04-19 ---
  {
    ...
    author: "OzoneNews Entertainment Desk",
    priority: 0.7,
    changeFrequency: "weekly",
  ...
  // --- Auto-added by wiki:publish 2026-04-21 ---
  {
    ...
    author: "OzoneNews Legal Desk",
    authorSlug: "OzoneNews-legal-desk",
    priority: 0.9,
    changeFrequency: "weekly",
