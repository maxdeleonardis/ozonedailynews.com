...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/events/news/claude-hacker-puerto-vallarta',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/events/news/claude-hacker-puerto-vallarta',
    siteName: 'ObjectWire',
...
export default function ClaudeHackerPuertoVallartaPage() {
  return <WikiArticle slug="events-news-claude-hacker-puerto-vallarta" />;
}
