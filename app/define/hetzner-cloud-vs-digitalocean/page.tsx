...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/define/hetzner-cloud-vs-digitalocean',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/define/hetzner-cloud-vs-digitalocean',
    siteName: 'ObjectWire',
...
export default function HetznerVsDigitalOceanPage() {
  return <WikiArticle slug="define-hetzner-cloud-vs-digitalocean" />;
}
