...
const SLUG = '/influencer/colleen-sheehan';
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'colleen.333 TikTok',
    'colleen 333 model',
    'Boston influencer model',
    'cosplay fashion creator',
    'festival influencer Instagram',
  ],
  ...
  openGraph: {
    ...
    section: 'Influencer',
    tags: ['Colleen Sheehan', 'colleen.333', 'Influencer', 'Instagram', 'Boston'],
...
export default function InfluencerColleenSheehanPage() {
  return <CreatorArticleDB slug="influencer-colleen-sheehan" />;
}
