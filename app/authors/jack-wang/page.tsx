...
export const metadata: Metadata = {
  ...
  description:
    'Jack Wang is a co-founder and contributor at OzoneNews covering technology, gaming, finance, and digital culture.',
  alternates: { canonical: 'https://www.ozonenetwork.news/authors/jack-wang' },
  openGraph: {
    title: 'Jack Wang | Co-Founder & Contributor, OzoneNews',
    description: 'Co-founder and contributor at OzoneNews covering technology, gaming, finance, and digital culture.',
  ...
  twitter: {
    card: 'summary',
    title: 'Jack Wang | Co-Founder, OzoneNews',
    description: 'Co-founder and contributor at OzoneNews covering technology, gaming, finance, and digital culture.',
  },
};

const BEATS = [
  'Technology', 'Gaming', 'Finance', 'Digital Culture', 'AI',
];

const HIGHLIGHTS = [
  { stat: '2+', label: 'Years at OzoneNews' },
  { stat: '5+', label: 'Beats Covered' },
  { stat: '15+', label: 'Published Articles' },
];

const SOCIAL = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=100086357572147',
    icon: 'f',
  },
];

export default function JackWangAuthorPage() {
  return (
    <main className="min-h-screen bg-white">
      <AuthorSchema
        name="Jack Wang"
        jobTitle="Co-Founder & Contributor"
        description="Jack Wang is a co-founder and contributor at OzoneNews covering technology, gaming, finance, and digital culture."
        url="https://www.ozonenetwork.news/authors/jack-wang"
        sameAs={[
          'https://www.facebook.com/profile.php?id=100086357572147',
        ]}
        knowsAbout={['Technology', 'Gaming', 'Finance', 'Digital Culture', 'AI']}
      ...
      <div className="bg-gray-950 text-white">
        <div className="max-w-5xl mx-auto px-6 pt-10 pb-14">
          ...
          <nav className="flex items-center gap-2 text-xs text-gray-500 mb-12 font-mono uppercase tracking-widest">
            ...
            <span>/</span>
            <span className="text-gray-400">Jack Wang</span>
          </nav>

          <div className="flex flex-col md:flex-row md:items-end gap-8">
            {/* Avatar */}
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden shrink-0 ring-2 ring-white bg-teal-700 flex items-center justify-center">
              <span className="text-white font-black text-3xl tracking-tight">JW</span>
            </div>
            {/* Identity */}
            <div className="flex-1">
              ...
              <p className="text-gray-300 text-xl font-medium">Co-Founder &amp; Contributor</p>
            </div>
            {/* Stats */}
          ...
          <div className="mt-10 border-l-4 border-gray-500 pl-5">
            <p className="text-gray-300 text-lg italic font-light leading-relaxed max-w-2xl">
              &ldquo;The best metaphors are the ones that make you see something you already knew differently.&rdquo;
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 text-white border-b border-gray-800">
        <div className="max-w-5xl mx-auto px-6 py-5 flex flex-wrap items-center gap-6 text-xs font-mono text-gray-400">
          <span>🤝 Co-Founder &middot; 2024</span>
          {SOCIAL.map((s) => (
            <a
              key={s.label}
              href={s.href}
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed text-[15px]">
                <p>
                  Jack Wang is a co-founder of{' '}
                  <Link href="/about" className="text-blue-600 hover:text-blue-800 underline">OzoneNews</Link>,
                  an independent nonprofit newsroom. He contributes reporting and editorial perspective
                  across technology, gaming, finance, and digital culture, bringing a distinctive
                  analytical voice to complex subject matter.
                </p>
                <p>
                  Wang&rsquo;s writing is characterized by an ability to draw sharp, original metaphors
                  that reframe technical subjects for a general audience, without sacrificing precision.
                  As a founding member of the newsroom, he helped shape OzoneNews&rsquo;s editorial
                  identity and commitment to primary-source, accuracy-first journalism.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <Suspense fallback={
                ...
                <AuthorArticlesServer authorSlug="jack-wang" authorName="Jack Wang" />
              </Suspense>
            </section>
          </div>
        </div>
