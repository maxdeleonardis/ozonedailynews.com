...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/influencer/daddywellness',
  },
  openGraph: {
    ...
    type: 'profile',
    url: 'https://www.objectwire.org/influencer/daddywellness',
    siteName: 'ObjectWire',
  },
};

export default function DaddyWellnessPage() {
  return <WikiArticle slug="influencer-daddywellness" />;
}
