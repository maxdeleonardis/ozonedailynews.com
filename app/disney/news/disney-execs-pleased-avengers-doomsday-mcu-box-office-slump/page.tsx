...
export const metadata: Metadata = {
  ...
  description:
    "Disney executives expressed satisfaction with early footage of Avengers: Doomsday in a February 25 Variety report, while rival studio heads privately",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Anonymous Disney insiders tell Variety the MCU's health doesn't hinge on a single film, but the ledger of recent Marvel flops tells a different story",
    type: 'article',
  ...
  twitter: {
    ...
    description:
      'Rival studio heads privately predict Doomsday will top 2026 box office. Disney says no single MCU film defines the franchise. The numbers since 2019 say',
  },
};
