...
export const metadata: Metadata = {
  ...
  description:
    'BlackRock and Fidelity purchased nearly $400 million in Bitcoin last week, even as they sold $250 million, generating a net bullish signal for crypto',
  keywords: [
  ...
  openGraph: {
    title: "BlackRock and Fidelity Bought $400M in Bitcoin Amid Gold's Worst Weekly Drop in Decades",
    description:
      "BlackRock and Fidelity bought nearly $400M in Bitcoin while selling $250M, a net bullish signal. The trades coincided with gold's steepest weekly decline",
    url: FULL_URL,
