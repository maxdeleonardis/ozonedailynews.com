          ...
          <div className="max-w-5xl mx-auto px-4 py-14">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
              ...
              <div className="relative w-28 h-28 sm:w-36 sm:h-36 rounded-xl overflow-hidden border-4 shrink-0" style={{ borderColor: 'rgba(255,255,255,0.3)' }}>
                <Image
                  src="/winter-olympics/b7e3a3821e924c2c81fb95df11f52884~tplv-jj85edgx6n-image-origin.jpeg"
                  alt="Alysa Liu - Olympic gold medalist at Milano Cortina 2026"
                  fill
        ...
        <div className="max-w-5xl mx-auto px-4 py-12">
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <article className="lg:col-span-2 space-y-12">
              ...
              {/* WHO */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">Who Is Alysa Liu?</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                    ...
                    <Link href="/winter-olympics" className="text-blue-600 hover:underline">Milano Cortina Winter Olympics</Link>.
                  </p>
                  <p>
                    She first made history in <strong>2019</strong>, winning the U.S. Championship at just{' '}
                    <strong>13 years old</strong>, making her the <strong>youngest U.S. Champion in the event&apos;s
                    history</strong>. She defended the title in 2020, cementing an early reputation as arguably the most
                    talented young female figure skater in the United States in a generation.
                  </p>
                  <p>
              ...
              {/* TIKTOK */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">Gold Medalist - Going Viral</h2>
                <p className="text-gray-600 text-sm mb-5">
                  Alysa Liu&apos;s Olympic gold sparked a wave of reaction content across social media.
                  This fan-made tribute spread rapidly across TikTok in the days following her win at Milano Cortina.
                </p>
                <div className="flex justify-center">
                  ...
                  >
                    <section>
                      <a target="_blank" rel="noopener noreferrer" title="@breezoiscrazy" href="https://www.tiktok.com/@breezoiscrazy?refer=embed">
                        @breezoiscrazy
                      </a>{' '}
                      Gold medalist!!! Champ&#127; |{' '}
                      ...
                      <a target="_blank" rel="noopener noreferrer" title="original sound - BRËËZO" href="https://www.tiktok.com/music/original-sound-7608837114402261791?refer=embed">
              ...
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">The Olympic Gold Medal Performance</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                ...
                <div className="not-prose mt-6 overflow-x-auto rounded-xl border border-gray-200">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {[
                        ['🥇', 'Alysa Liu', 'USA', '233.17'],
                        ['🥈', 'You Young', 'South Korea', '228.44'],
                        ['🥉', 'Kaori Sakamoto', 'Japan', '224.92'],
                      ].map(([medal, skater, country, score]) => (
                        <tr key={skater} className="even:bg-gray-50">
                          <td className="px-4 py-2.5 text-lg">{medal}</td>
                          <td className="px-4 py-2.5 font-semibold text-gray-900">{skater}</td>
                          <td className="px-4 py-2.5 text-gray-600">{country}</td>
                          <td className="px-4 py-2.5 font-bold text-gray-900">{score}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
              ...
              {/* EARLY LIFE & CAREER */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">Early Life & Career</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                    Alysa Liu was born on <strong>August 8, 2005</strong>, in <strong>Fremont, California</strong>,
                    to a Chinese-American family. She began figure skating as a young child and rapidly progressed
                    through the junior ranks, demonstrating a rare combination of natural athleticism, technical
                    fearlessness, and artistic instinct.
                  </p>
                  <p>
                    At just <strong>13 years old</strong> in <strong>2019</strong>, Liu won the U.S. Figure
                    Skating Championships, becoming the <strong>youngest U.S. Champion in the event&apos;s
                    history</strong>. She repeated the feat in <strong>2020</strong>, one of only a handful
                    of champions to defend the U.S. title in back-to-back years at that age.
                  </p>
                  <p>
                    Her signature element is the <strong>triple Axel</strong>, one of figure skating&apos;s most
                    demanding jumps and one that only a small number of women in the world can execute reliably
                    in competition. Her consistent and technically clean triple Axel has been a cornerstone of
                    her competitive programs throughout her career.
                  </p>
                </div>
              </section>

              {/* THE BEIJING OMISSION & REBUILD */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">The Beijing Omission & The Rebuild</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                    In one of the more controversial selection decisions in recent U.S. figure skating history,
                    Liu was <strong>left off the Team USA roster for the 2022 Beijing Winter Olympics</strong>
                    following the U.S. Championships selection event. The decision drew significant public debate,
                    given her record as a two-time national champion and her trajectory as one of the sport&apos;s
                    brightest young performers.
                  </p>
                  <p>
                    ...
                    version of herself as a skater. She later described the Beijing omission as the catalyst
                    for the growth that made her an Olympic champion.
                  </p>
                  <p>
                    &quot;Not making Beijing was the most painful thing that ever happened to me athletically,&quot;
                    she said after her gold medal. &quot;And it was the best thing that ever happened to me.
                    I came back a different skater.&quot;
                  </p>
                </div>

                <div className="not-prose mt-6 bg-blue-50 border border-blue-200 rounded-xl p-5">
                  <h3 className="font-bold text-gray-900 mb-3 text-sm uppercase tracking-wider">Road to Gold: Turning Points</h3>
              ...
              {/* WHY SHE MATTERS */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">Why Alysa Liu Matters for American Figure Skating</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                  ...
                  <p>
                    ...
                    U.S. Figure Skating president Ramsey Baker described her gold as &quot;a transformational
                    moment for the sport in this country&quot; and validation of the federation&apos;s
                    investment in elite athlete development programs launched after the 2022 Beijing cycle.
                  </p>
                  <p>
                  ...
                  <p>
                    &quot;I want this to be the beginning of something,&quot; Liu said. &quot;Not just for me,
                    but for every little girl who puts on skates in America and dreams about this moment.&quot;
                  </p>
                </div>
              </section>
              ...
              {/* CELEBRITY ATTENTION */}
              <section>
                <h2 className="text-2xl font-bold text-gray-900 mb-4 border-b-2 border-gray-900 pb-2">Celebrity Support & Mainstream Crossover</h2>
                <div className="prose prose-lg max-w-none">
                  <p>
                    ...
                    social media calling Liu &quot;a true artist on ice,&quot; while <strong>Taylor Swift</strong>{' '}
                    posted a story wishing her &quot;all the magic&quot; before the short program.
                  </p>
                  <p>
                    The dual celebrity endorsements ignited the internet. Search interest in Liu spiked by
                    over <strong>800 percent</strong> in the week leading up to competition, and her social
                    media following doubled. The moment transformed her from a known commodity in figure
                    skating circles into a genuine mainstream sports celebrity heading into the most-watched
                    event of the Games.
                  </p>
                </div>
              </section>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-6 space-y-6">
                  ...
                  <div style={{ background: 'linear-gradient(135deg, #0f172a, #1e3a5f, #b45309)', padding: '0' }}>
                    <div className="relative w-full h-56">
                      ...
                      <div style={{ position: 'absolute', bottom: '10px', left: '14px', right: '14px' }}>
                        <h2 style={{ color: '#fff', fontWeight: 700, fontSize: '1.05rem', margin: 0 }}>Alysa Liu</h2>
                ...
                <div className="bg-yellow-50 border-2 border-yellow-300 rounded-xl p-5">
                  <h3 className="font-bold text-gray-900 mb-2 text-sm uppercase tracking-wider">🥇 Olympic Champion</h3>
                  <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                    Alysa Liu won gold at the <strong>2026 Winter Olympics</strong> in Milano Cortina with
                    a score of <strong>233.17 points</strong>, ending a 20-year American medal drought in
                    women&apos;s singles figure skating.
                  </p>
                  <Link href="/winter-olympics" className="block text-center bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold text-xs py-2.5 px-4 rounded-lg transition-colors">
