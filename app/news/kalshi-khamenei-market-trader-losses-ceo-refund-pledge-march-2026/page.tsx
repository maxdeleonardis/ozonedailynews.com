...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/news/kalshi-khamenei-market-trader-losses-ceo-refund-pledge-march-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/news/kalshi-khamenei-market-trader-losses-ceo-refund-pledge-march-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/news/kalshi-khamenei-prediction-market-settlement-march-2026.jpg'],
...
export default function KalshiKhameneiMarketPage() {
  return <WikiArticle slug="news-kalshi-khamenei-market-trader-losses-ceo-refund-pledge-march-2026" />;
}
