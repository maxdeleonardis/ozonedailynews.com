...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/world-cup/news/host-cities-security-funding-frozen-dhs-shutdown',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/world-cup/news/host-cities-security-funding-frozen-dhs-shutdown',
    siteName: 'ObjectWire',
    authors: ['Alfansa'],
...
export default function WorldCupSecurityFundingPage() {
  return <WikiArticle slug="world-cup-news-host-cities-security-funding-frozen-dhs-shutdown" />;
}
