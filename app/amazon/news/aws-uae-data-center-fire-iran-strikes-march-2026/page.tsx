...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/amazon/news/aws-uae-data-center-fire-iran-strikes-march-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/amazon/news/aws-uae-data-center-fire-iran-strikes-march-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/amazon/aws-uae-data-center-fire-iran-march-2026.jpg'],
...
export default function AWSUAEDataCenterFirePage() {
  return <WikiArticle slug="amazon-news-aws-uae-data-center-fire-iran-strikes-march-2026" />;
}
