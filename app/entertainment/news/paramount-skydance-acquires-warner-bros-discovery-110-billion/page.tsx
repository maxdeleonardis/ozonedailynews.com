...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/entertainment/news/paramount-skydance-acquires-warner-bros-discovery-110-billion',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/entertainment/news/paramount-skydance-acquires-warner-bros-discovery-110-billion',
    siteName: 'ObjectWire',
...
export default function ParamountSkydanceWBDPage() {
  return <WikiArticle slug="entertainment-news-paramount-skydance-acquires-warner-bros-discovery-110-billion" />;
}
