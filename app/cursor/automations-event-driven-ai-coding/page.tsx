...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/cursor/automations-event-driven-ai-coding' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/cursor/automations-event-driven-ai-coding',
    siteName: 'ObjectWire',
    authors: ['Alfanasa'],
...
export default function CursorAutomationsPage() {
  return <WikiArticle slug="cursor-automations-event-driven-ai-coding" />;
}
