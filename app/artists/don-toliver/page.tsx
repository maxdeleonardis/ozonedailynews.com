...
export const metadata: Metadata = {
  title: 'Don Toliver | Artist Profile, Discography & Latest Music',
  description:
    'Complete profile of Don Toliver, Houston melodic trap pioneer signed to Cactus Jack Records. Discography, collaborations with Travis Scott and Kanye West,',
  keywords: [
    'Don Toliver',
    'Cactus Jack Records',
    'Travis Scott',
  ...
  openGraph: {
    type: 'profile',
    title: 'Don Toliver | Melodic Trap Pioneer',
    description:
