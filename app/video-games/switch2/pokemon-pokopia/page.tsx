...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/switch2/pokemon-pokopia',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/switch2/pokemon-pokopia',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/entertainment/new_pokemon_game.PNG'],
...
export default function PokemonPokopiaPage() {
  return <WikiArticle slug="video-games-switch2-pokemon-pokopia" />;
}
