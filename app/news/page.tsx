...
export const metadata: Metadata = {
  title: 'News | Latest Stories from Ozone Daily News',
  description: 'All the latest stories from Ozone Daily News — space exploration, rockets, engineering, science, defense, and policy.',
  ...
  twitter: {
    ...
    title: 'News | Latest Stories from Ozone Daily News',
    description: 'All the latest stories from Ozone Daily News.',
  },
};
      ...
      <header className="border-b-2 border-black bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          <nav className="text-xs text-gray-500 mb-4">
            ...
            <span className="text-black font-semibold">News</span>
          </nav>
          <div className="flex items-start gap-4">
            <div className="h-12 w-1.5 bg-orange-500 shrink-0 mt-1" />
            <div>
              <h1 className="text-4xl sm:text-5xl font-black tracking-tight text-black">News</h1>
              <p className="mt-2 text-gray-600 text-base sm:text-lg max-w-2xl">
                The latest from Ozone Daily News — space, rockets, engineering, science, defense, and policy.
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        {articles.length === 0 ? (
          <div className="py-24 text-center">
            ...
            <Link href="/" className="mt-4 inline-block text-sm text-orange-500 hover:underline">← Back to home</Link>
          </div>
        ) : (
          <>
            {hero && (
              ...
              >
                {hero.imageUrl ? (
                  ...
                  <div className="w-full sm:w-80 aspect-[16/9] sm:aspect-auto bg-orange-50 border-r border-orange-100 flex items-center justify-center shrink-0">
                    <span className="text-orange-400 text-4xl font-black opacity-40">ON</span>
                  </div>
                )}
            ...
            {grid.length > 0 && (
              <>
                <p className="text-xs text-gray-400 uppercase tracking-widest font-semibold mb-6">{articles.length} stories</p>
                    ...
                    >
                      {article.imageUrl ? (
                        ...
                        <div className="w-full aspect-[16/9] bg-orange-50 border-b border-orange-100 flex items-center justify-center shrink-0">
                          <span className="text-orange-400 text-3xl font-black opacity-30">ON</span>
                        </div>
                      )}
