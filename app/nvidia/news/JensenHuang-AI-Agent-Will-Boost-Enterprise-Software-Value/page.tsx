...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/nvidia/news/JensenHuang-AI-Agent-Will-Boost-Enterprise-Software-Value',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/nvidia/news/JensenHuang-AI-Agent-Will-Boost-Enterprise-Software-Value',
    siteName: 'ObjectWire',
...
export default function JensenHuangAIEnterprisePage() {
  return <WikiArticle slug="nvidia-news-JensenHuang-AI-Agent-Will-Boost-Enterprise-Software-Value" />;
}
