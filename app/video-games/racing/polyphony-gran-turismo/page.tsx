...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/racing/polyphony-gran-turismo',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/racing/polyphony-gran-turismo',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/entertainment/gran_turismo.PNG'],
...
export default function PolyphonyGranTurismoPage() {
  return <WikiArticle slug="video-games-racing-polyphony-gran-turismo" />;
}
