...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/tech/news/gaming-industry-layoffs-ea-sony-riot-ubisoft-february-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/tech/news/gaming-industry-layoffs-ea-sony-riot-ubisoft-february-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/tech/gaming-industry-layoffs-ea-sony-riot-ubisoft-february-2026.jpg'],
...
export default function GamingLayoffsFebruary2026Page() {
  return <WikiArticle slug="tech-news-gaming-industry-layoffs-ea-sony-riot-ubisoft-february-2026" />;
}
