...
export const metadata: Metadata = {
  title:
    'Anthropic Court Filings Disclose $5 Billion Total',
  description:
  ...
  openGraph: {
    title:
      'Anthropic Court Filing | $5 Billion Total Revenue Since',
    description:
  ...
  twitter: {
    ...
    title: 'Anthropic Filed $5B Total Revenue in DoD Lawsuit.',
    description:
