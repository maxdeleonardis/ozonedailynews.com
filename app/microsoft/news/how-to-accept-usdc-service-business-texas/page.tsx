...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/microsoft/news/how-to-accept-usdc-service-business-texas',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/microsoft/news/how-to-accept-usdc-service-business-texas',
    siteName: 'ObjectWire',
...
export default function USDCTexasServiceBusinessPage() {
  return <WikiArticle slug="microsoft-news-how-to-accept-usdc-service-business-texas" />;
}
