...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/microsoft/news/nvidia-groq-inference-processor-gtc-2026' },
  openGraph: {
    ...
    type: 'article', url: 'https://www.objectwire.org/microsoft/news/nvidia-groq-inference-processor-gtc-2026', siteName: 'ObjectWire',
...
export default function NvidiaGroqGTCPage() {
  return <WikiArticle slug="microsoft-news-nvidia-groq-inference-processor-gtc-2026" />;
}
