...
export const metadata: Metadata = {
  ...
  description:
    'William Rodriguez is a staff writer at OzoneNews covering news, technology, gaming, and culture. He focuses on investigative features and product analysis',
