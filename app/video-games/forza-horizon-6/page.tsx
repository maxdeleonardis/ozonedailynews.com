...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/forza-horizon-6',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/forza-horizon-6',
    siteName: 'ObjectWire',
...
export default function ForzaHorizon6Page() {
  return <WikiArticle slug="video-games-forza-horizon-6" />;
}
