...
export const contentRegistry: ContentEntry[] = [
  ...
  {
    slug: '/video-games/nintendo/pokemon-pokopia-2-million-copies-4-days-switch-2',
    title: 'Pokémon Pokopia Sells 2.2M Copies in 4 Days, Shattering Spin-Off Records | ObjectWire',
    description: 'The Pokémon Company confirms Pokémon Pokopia sold 2.2 million units in its first four days on Nintendo Switch 2. Japan accounted for nearly 1M copies. Nintendo stock surged 15%.',
    publishDate: '2026-03-12',
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Pokémon Pokopia', 'Nintendo', 'Switch 2', 'Sales Record', 'Game Freak', 'Omega Force', 'Gaming'],
    author: 'Conan Boyle',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['Tenstorrent', 'RISC-V', 'AI Hardware', 'QuietBox 2', 'Jim Keller', 'Nvidia', 'Open Source AI', 'TT-Buda', 'LLM Inference'],
    author: 'Jack Wang',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['AI Security', 'DryRun Security', 'Agentic AI', 'Claude', 'Codex', 'Gemini', 'Security Vulnerabilities', 'Developer Tools', 'Software Engineering'],
    author: 'Jack Wang',
    authorSlug: 'jack-wang',
    priority: 0.9,
    changeFrequency: 'weekly',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['YouTube', 'Ken Jennings', 'John Roderick', 'Omnibus Project', 'AI Moderation', 'Content Moderation', 'Contextual Blindness', 'Podcast'],
    author: 'Jack Wang',
    authorSlug: 'jack-wang',
    priority: 0.85,
    changeFrequency: 'weekly',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['CrowdStrike', 'Perplexity', 'Comet Enterprise', 'Cybersecurity', 'Falcon', 'Seraphic Security', 'Ask 2026', 'Agentic AI'],
    author: 'Jack Wang',
    authorSlug: 'jack-wang',
    priority: 0.9,
    changeFrequency: 'daily',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['Perplexity', 'AI Agent', 'Personal Computer', 'Ask 2026', 'Aravind Srinivas', 'Developer APIs', 'Perplexity Finance', 'Agentic AI'],
    author: 'Jack Wang',
    authorSlug: 'jack-wang',
    priority: 0.9,
    changeFrequency: 'daily',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['Anthropic', 'Claude', 'GPT-4.1', 'OpenAI', 'Federal Government', 'AI Policy', 'Trump Executive Directive', 'StateChat', 'Senate AI'],
    author: 'Jack Wang',
    authorSlug: 'jack-wang',
    priority: 0.95,
    changeFrequency: 'daily',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Donkey Kong Bananza', 'Nintendo', 'Switch 2', 'GDC 2026', 'Voxels', 'Game Design', 'Gaming'],
    author: 'Conan Boyle',
    authorSlug: 'conan-boyle',
    priority: 0.9,
    changeFrequency: 'daily',
  ...
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Clair Obscur', 'GDC 2026', 'Game of the Year', 'Sandfall Interactive', 'Indie Games', 'Gaming'],
    author: 'ObjectWire Gaming Desk',
    priority: 0.9,
    changeFrequency: 'daily',
    featured: true,
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Outersloth', 'Innersloth', 'Among Us', 'Generative AI', 'Indie Games', 'GDC 2026', 'Gaming'],
    author: 'ObjectWire Gaming Desk',
    priority: 0.8,
    changeFrequency: 'weekly',
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Marathon', 'Bungie', 'Patch Notes', 'UESC', 'Extraction Shooter', 'Gaming'],
    author: 'Conan Boyle',
    authorSlug: 'conan-boyle',
    priority: 0.8,
    changeFrequency: 'weekly',
  },
  {
    ...
    modifiedDate: '2026-03-12',
    category: 'Gaming',
    tags: ['Toxic Commando', 'John Carpenter', 'Saber Interactive', 'Co-op Shooter', 'Swarm Engine', 'Gaming'],
    author: 'Conan Boyle',
    authorSlug: 'conan-boyle',
    priority: 0.8,
    changeFrequency: 'weekly',
  ...
  // ===========================================================================
  {
    slug: '/tech/news/anthropic-court-filings-disclose-5-billion-in-total-revenue',
    title: 'Anthropic Court Filings Disclose $5 Billion in Total Revenue | ObjectWire',
    description: 'Court documents in a DoD contractor lawsuit reveal Anthropic has generated $5 billion in cumulative revenue against a $19 billion annualized run rate. Full financial breakdown.',
    publishDate: '2026-03-12',
    modifiedDate: '2026-03-12',
    category: 'Technology',
    tags: ['Anthropic', 'Claude', 'AI Revenue', 'Court Filings', 'Tech', 'AI'],
  ...
  // ===========================================================================
  {
    ...
    tags: ['Unreal Engine', 'Fortnite', 'Hollywood', 'Virtual Production', 'ICVFX', 'Entertainment', 'Epic Games'],
    author: 'Jack Sterling',
    priority: 0.8,
    changeFrequency: 'weekly',
  },
  ...
  },
  {
    ...
    description: "In-depth review of Don Toliver's OCTANE album featuring Kanye West (Ye), Travis Scott, and Young Thug. Track-by-track analysis and 8/10 score.",
    publishDate: "2026-01-30",
    modifiedDate: "2026-03-29",
    category: "Entertainment",
    tags: ["Don Toliver", "OCTANE", "Kanye West", "Travis Scott", "Young Thug", "Album Review", "Cactus Jack Records"],
  ...
  },
  {
    ...
    imageUrl: "/bio-hacking/pexels-pixabay-289290.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/earth/pexels-hungtran-3699436.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/earth/pexels-george-desipris-726478.jpg",
    imageWidth: 1200,
    imageHeight: 675,
    title: "Trump",
  ...
  },
  {
    ...
    imageUrl: "https://kzcwclprrtonpsnownbl.supabase.co/storage/v1/object/public/blog-images/winter-olympics/alysa-liu-2026-olympic-gold.jpeg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    description: "Full biography of Yellz0, real name Aniela Verbin. Pennsylvania-born TikTok star with 4M+ followers, model, and content creator known for lifestyle content.",
    publishDate: "2026-02-21",
    modifiedDate: "2026-03-29",
    category: "Entertainment",
    tags: ["Yellz0", "Aniela Verbin", "TikTok", "Influencer", "Content Creator", "Social Media"],
    author: "ObjectWire Influencer Desk",
    priority: 0.7,
    changeFrequency: "weekly",
    imageUrl: "/influncer/yellz0_what_cup_size.PNG",
  },
  {
    slug: "/youtube",
  ...
  // --- Amazon (2) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/amazon/andy-jassy-ai-workforce-headcount-cnbc-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/amazon/aws-uae-data-center-fire-iran-march-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/video-games/endfield_gryphline.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/video-games/crimson-desert-blackspace-engine-4k-60fps-ray-tracing-digital-foundry-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/video-games/unreal-engine-epic-games-film-automotive-architecture-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/video-games/marathon-server-slam-steam-concurrent-players-peak-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/news/kalshi-khamenei-prediction-market-settlement-march-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Science (2) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/bio-hacking/eledon-pharmaceuticals-tegoprubart-cd40l.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/bio-hacking/life-biosciences-er100-fda-clearance.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Technology (11) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/apple/apple-core-ai-framework-wwdc-2026-core-ml-replacement.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/apple/apple-march-2026-products-macbook-iphone-17e-event.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/nvidia/nvidia-groq-lpu-inference-gtc-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/tech/grok-xai-pentagon-classified-approval-federal-safety-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/tech/minimax-maxclaw-openclaw-cloud-agent-clawbot-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/technology/grok-pentagon-federal-safety-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- YouTube (9) ---
  {
    ...
    description: "Richie Lovelace, known as Daddy Wellness, is a Miami-based wellness entrepreneur with 2M+ Instagram followers. Founder of Dialed University, host of TSL Time podcast.",
    publishDate: "2026-03-03",
    modifiedDate: "2026-03-29",
    category: "Influencer",
    tags: ["Daddy Wellness", "Richie Lovelace", "Dialed University", "TSL Time", "Wellness Influencer"],
    author: "ObjectWire Editorial",
    imageUrl: "/influncer/daddy_wellness.jpg",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
  ...
  // --- Technology (1) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/tech/gaming-industry-layoffs-ea-sony-riot-ubisoft-february-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // ===========================================================================
  // AUTO-SYNCED 2026-03-12 — 12 entries added by scripts/sync-registry.ts
  // Review publishDate / modifiedDate / featured / imageUrl on each entry.
  // ===========================================================================
  ...
  },
  {
    ...
    modifiedDate: "2026-03-12",
    category: "Events",
    tags: ["Events", "Gdc 2026", "Valve Steam Machine Steam Frame Compatibility Gdc 2026"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- Gaming (6) ---
  {
    ...
    description: "Pearl Abyss responds to fan accusations that the studio is deliberately hiding PS5 and Xbox Series X|S footage of Crimson Desert ahead of its March 19, 2026 lau",
    publishDate: "2026-03-12",
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "New", "Crimson Desert", "Console Footage Pushback"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    description: "Windrose Crew says the pirate survival game won\\",
    publishDate: "2026-03-12",
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "New", "Windrose", "Release Date Holdoff"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "News", "Arc Raiders Discord Plaintext Security"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    description: "Epic Games filed a lawsuit on March 5 against former contractor Hayden Cohen, who allegedly ran the",
    publishDate: "2026-03-12",
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "News", "Epic Games Sues Fortnite Leaks Contractor"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    title: "Rockstar Pulls GTA 6 IDs from PlayStation Store After Profile Exploit | ObjectWire",
    description: "Rockstar Games and Sony removed Grand Theft Auto 6 title IDs from the PlayStation Store backend after fans exploited a glitch to add the unreleased game to thei",
    publishDate: "2026-03-12",
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "News", "Rockstar Gta6 Psn Profile Exploit"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-12",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "Resident Evil Requiem", "Steam Launch Record 267k Concurrent Players"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- Technology (1) ---
  {
    ...
    imageUrl: "/default/pawel-czerwinski-fpZZEV0uQwA-unsplash.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- YouTube (3) ---
  {
    ...
    modifiedDate: "2026-03-12",
    category: "YouTube",
    tags: ["YouTube", "Creator Economy", "Spanish"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-12",
    category: "YouTube",
    tags: ["YouTube", "Creator Economy", "Thefellas"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  {
    ...
    title: "Punchin",
    description: "Complete profile of Punchin",
    publishDate: "2026-03-12",
    modifiedDate: "2026-03-12",
    category: "YouTube",
    tags: ["YouTube", "Creator Economy", "Thefellas", "Punchin"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- Business (1) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/elon-musk/terafab-tesla-chip-fab.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Entertainment (3) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/apple/apple-tv-outcome-trailer-2026.jpg",
    imageWidth: 1200,
    imageHeight: 675,
    ...
    category: "Entertainment",
    tags: ["Entertainment", "Apple TV+", "Outcome", "Keanu Reeves", "Jonah Hill", "Streaming 2026"],
    author: "ObjectWire Entertainment Desk",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/apple/apple-tv-spring-2026-slate.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/entertainment/conan_obrian",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/entertainment/marty_supreme",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Politics (1) ---
  {
    ...
    imageUrl: "/entertainment/trump_tiktok.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // ===========================================================================
  // AUTO-SYNCED 2026-03-19 — 20 entries added by scripts/sync-registry.ts
  // Review publishDate / modifiedDate / featured / imageUrl on each entry.
  // ===========================================================================
  ...
  // --- Austin (1) ---
  {
    slug: "/austin/waymo-city-council-bufords-ambulance-obstruction-2026",
    title: "Austin City Council Summons Waymo After Robotaxi Blocked Ambulance at Buford",
    description: "Austin City Council has formally invited Waymo to a joint Public Safety and Mobility committee hearing on April 29, 2026, after a driverless taxi obstructed an",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Austin",
    tags: ["Austin"],
  ...
  // --- Business (1) ---
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Business",
    tags: ["Elon Musk", "Tesla", "xAI", "Spacex Xai Merger 1 75 Trillion Ipo Orbital Ai 2026"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- California (1) ---
  {
    ...
    description: "California-based tech companies announced 26,283 job cuts year-to-date through February 2026, according to Challenger, Gray & Christmas — with Amazon, Meta, Wor",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "California",
    tags: ["California"],
  ...
  // --- Events (1) ---
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Events",
    tags: ["Events", "Gtc 2026", "Closing Day 3 Intel Microsoft Agentic March 18 2026"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- Fortnite (1) ---
  {
    slug: "/fortnite/epic-games-vbucks-shrinkflation-chapter-7-season-2-2026",
    title: "Epic Games Implements Fortnite",
    description: "Epic Games has reduced the V-Bucks included in every paid bundle effective March 19, 2026, while keeping dollar prices unchanged. The $8.99 pack drops from 1,00",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Fortnite",
    tags: ["Fortnite"],
  ...
  // --- Gaming (1) ---
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Gaming",
    tags: ["Video Games", "Gaming", "Gamestop", "News", "Gamestop Ps3 Xbox 360 Wii U Retro Consoles March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "weekly",
  },
  ...
  // --- Reference (2) ---
  {
    slug: "/define/bets-off-act",
    title: "BETS OFF Act Explained: What It Is, What It Bans, and Who It Targets | ObjectWire",
    description: "Senator Chris Murphy and Representative Greg Casar introduced the BETS OFF Act on March 17, 2026, to ban CFTC-regulated prediction markets from listing contract",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Reference",
    tags: ["Definitions", "Reference", "Bets Off Act"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "monthly",
  },
  {
    slug: "/define/democrate/dhs-funding-shutdown-senate-democrats-counteroffer-march-2026",
    title: "Democrats Send DHS Funding Proposal Amid 32-Day Partial Shutdown | ObjectWire",
    description: "Senate Democrats delivered their latest counteroffer to the White House on Monday night to fund the Department of Homeland Security, as the partial government s",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Reference",
    tags: ["Definitions", "Reference", "Democrate", "Dhs Funding Shutdown Senate Democrats Counteroffer March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.6,
    changeFrequency: "monthly",
  },
  ...
  // --- Technology (11) ---
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Microsoft", "Big Tech", "Xbox", "Project Moorcroft Cancelled Game Pass Demos Gdc 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["NVIDIA", "AI Hardware", "GPU", "News", "Nvidia Engineer Inference Budget Token Salary Gtc 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["OpenAI", "Artificial Intelligence", "Openai Aws Pentagon Classified Ai Deal March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/saas/news/shopify-agentic-storefronts-chatgpt-default-march-2026",
    title: "Shopify Activates",
    description: "Shopify notified its millions of merchants on March 11, 2026 that",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["SaaS", "Software", "News", "Shopify Agentic Storefronts Chatgpt Default March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/tech/alphafold-protein-complex-structures-database-2026",
    title: "AlphaFold Database Adds 1.7 Million Protein Complex Structures in Historic Expansion | ObjectWire",
    description: "The AlphaFold Protein Structure Database has added protein complex structures for the first time, with 1.7 million high-confidence homodimer predictions produce",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Alphafold Protein Complex Structures Database 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/tech/anthropic-private-equity-10-billion-blackstone-joint-venture-2026",
    title: "Anthropic & Private Equity: A $10 Billion Play for Enterprise AI Dominance | ObjectWire",
    description: "Anthropic is in advanced talks with Blackstone, Hellman & Friedman, and Permira to form a $10 billion AI joint venture that would embed Claude directly into hun",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Anthropic Private Equity 10 Billion Blackstone Joint Venture 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/tech/dell/dell-pro-max-gb300-grace-blackwell-ultra-desktop-gtc-2026",
    title: "Dell Ships First Desktop with Nvidia GB300 Grace Blackwell Ultra for AI Agents | ObjectWire",
    description: "Dell Technologies announced at Nvidia GTC 2026 that it is the first OEM to ship a desktop powered by Nvidia",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Dell", "Dell Pro Max Gb300 Grace Blackwell Ultra Desktop Gtc 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/entertainment/alibaba.PNG",
    imageWidth: 1200,
    imageHeight: 675,
    ...
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Alibaba", "Wukong Ai Agent Enterprise Platform March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    ...
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Stablecoins"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/technology/stablecoins/mastercard-bvnk-acquisition-1-8-billion-march-2026",
    title: "Mastercard to Acquire BVNK for $1.8 Billion in Largest Digital Asset Bet Yet | ObjectWire",
    description: "Mastercard announced a definitive agreement to acquire London-based stablecoin infrastructure provider BVNK for up to $1.8 billion on March 17, 2026, including",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
    tags: ["Technology", "Stablecoins", "Mastercard Bvnk Acquisition 1 8 Billion March 2026"],
    author: "ObjectWire Editorial",
    priority: 0.7,
    changeFrequency: "weekly",
  },
  {
    slug: "/technology/stablecoins/paypal-pyusd-70-markets-global-expansion-march-2026",
    title: "PayPal Expands PYUSD Stablecoin to 70 Markets Worldwide | ObjectWire",
    description: "PayPal announced on March 18, 2026, that its dollar-backed stablecoin PayPal USD (PYUSD) is now available in 70 markets across Asia-Pacific, Europe, Latin Ameri",
    publishDate: "2026-03-19",
    modifiedDate: "2026-03-19",
    category: "Technology",
  ...
  },
  {
    ...
    imageUrl: "/crypto/coinbase-new-york-ath-ray-nct-strk-2026.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/crypto/warren-mrbeast-step-crypto-children.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Politics (2) ---
  {
    ...
    imageUrl: "/trump/musk-tsa-shutdown.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/trump/trump-totalenergies-offshore-wind.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Automotive (1) ---
  {
    ...
    imageUrl: "/entertainment/waymo.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Gaming (1) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/video-games/thumbnail.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // --- Legal (1) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/default/aoc.PNG",
    imageWidth: 1200,
    imageHeight: 675,
    title: "AOC Calls MLB",
  ...
  // --- Politics (3) ---
  {
    ...
    imageUrl: "https://www.objectwire.org/trump/ice-arrest-sfo-airport.jpg",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "/trump/trump-ice-agents-drop-masks-airports.PNG",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  },
  {
    ...
    imageUrl: "https://www.objectwire.org/default/Tencent%20embeds%20OpenClaw%20.png",
    imageWidth: 1200,
    imageHeight: 675,
  ...
  // ===========================================================================
  // AUTO-SYNCED 2026-03-25 — 2 entries added by scripts/sync-registry.ts
  // Review publishDate / modifiedDate / featured / imageUrl on each entry.
  // ===========================================================================

  // --- Politics (1) ---
  {
    slug: "/trump/trump-auto-tariffs-25-percent-april-3",
    imageUrl: "/trump/trump-auto-tariffs-april.jpg",
    imageWidth: 1200,
    imageHeight: 675,
    title: "Trump Signs 25% Auto Tariff Order \u2014 Global Carmakers Brace for April 3 Shock | ObjectWire",
    description: "President Trump signed an executive order imposing 25% tariffs on all imported automobiles and auto parts, effective April 3. The move sends shockwaves through Detroit, Tokyo, Stuttgart, and Seoul.",
    publishDate: "2026-03-25",
    modifiedDate: "2026-03-25",
    category: "Politics",
    tags: ["Donald Trump", "US Politics", "Trade War", "Automotive", "Tariffs"],
    author: "Conan Boyle",
    authorSlug: "conan-boyle",
    priority: 0.8,
    changeFrequency: "weekly",
  ...
  // --- Technology (1) ---
  {
    ...
    imageUrl: "/nvidia/nvidia-blackwell-b300-datacenter.jpg",
    imageWidth: 1200,
    imageHeight: 675,
    title: "NVIDIA\u2019s Blackwell B300 Demand Has \u2018Completely Broken\u2019 Data Center Planning Models | ObjectWire",
    description: "Hyperscalers are ordering NVIDIA\u2019s Blackwell B300 GPUs at a pace that has left data center operators scrambling. Lead times have stretched to 52 weeks, colocation capacity is sold out through 2027.",
    publishDate: "2026-03-25",
    modifiedDate: "2026-03-25",
    category: "Technology",
    tags: ["NVIDIA", "AI", "GPU", "Data Centers", "Blackwell", "Infrastructure"],
    author: "Conan Boyle",
    authorSlug: "conan-boyle",
    priority: 0.8,
    changeFrequency: "weekly",
  },
  // --- Auto-added by wiki:publish 2026-03-25 ---
  {
    slug: "/google/google-research-releases-turboquant",
    title: "Google Research Releases TurboQuant: 6x KV Cache Compression With Zero Accuracy Loss",
    description: "A training-free quantization suite slashes LLM memory requirements by at least 6x and delivers up to 8x faster attention — with no measurable accuracy loss on long-context benchmarks.",
  ...
  // --- Creator / Influencer Articles ---
  {
    ...
    category: "Entertainment",
    tags: ["Eden Gross", "TikTok", "Creator Economy", "Influencer", "Dance", "Biography"],
    author: "ObjectWire Influencer Desk",
    imageUrl: "/influncer/eden_gross.PNG",
    imageAlt: "Eden Gross TikTok dance and lifestyle creator",
    priority: 0.7,
    changeFrequency: "monthly",
  },
  {
    ...
    modifiedDate: "2026-03-27",
    category: "Entertainment",
    tags: ["Mika Lafuente", "Model", "Influencer", "TikTok", "Instagram", "Biography"],
    author: "ObjectWire Influencer Desk",
    imageUrl: "/influncer/mika.PNG",
    imageAlt: "Mika Lafuente Spanish model and TikTok content creator",
    priority: 0.7,
    changeFrequency: "monthly",
  },
  {
    ...
    modifiedDate: "2026-03-27",
    category: "Entertainment",
    tags: ["queenkalin", "Kalin", "TikTok", "Creator Economy", "Brazilian Influencer", "Biography"],
    author: "ObjectWire Influencer Desk",
    imageUrl: "/influncer/queenkalin.PNG",
    imageAlt: "queenkalin Kalin Brazilian TikTok Creator",
    priority: 0.7,
    changeFrequency: "monthly",
  },
  // ===========================================================================
  // AUTO-SYNCED 2026-03-29 — 20 entries added by scripts/sync-registry.ts
  // Review publishDate / modifiedDate / featured / imageUrl on each entry.
  // ===========================================================================
  ...
  // --- Legal (3) ---
  {
    ...
    description: "Two separate juries in New Mexico and Los Angeles found Meta Platforms liable for harming children on the same day, a $375 million civil penalty in New Mexico a",
    publishDate: "2026-03-29",
    modifiedDate: "2026-03-29",
    category: "Legal",
  ...
  },
  {
    ...
    description: "A New Mexico jury found Meta violated state consumer protection law by making false and misleading statements about the safety of its platforms for teenagers, o",
    publishDate: "2026-03-29",
    modifiedDate: "2026-03-29",
    category: "Legal",
  ...
  // --- Login (1) ---
  {
    ...
    description: "ObjectWire coverage of {mode === 'signin' ? 'Sign in' : 'Create account'}.",
    publishDate: "2026-03-29",
    modifiedDate: "2026-03-29",
    category: "Login",
    tags: ["Login"],
  ...
  },
  {
    ...
    title: "Meta Begins",
    description: "Meta Platforms launched a new wave of job cuts on March 25, 2026, targeting hundreds of employees across Reality Labs, social media teams, and recruiting, a str",
    publishDate: "2026-03-29",
    modifiedDate: "2026-03-29",
    category: "Social Media",
  ...
  },
  {
    ...
    title: "Cloudflare Launches Dynamic Workers Open Beta for AI Code Execution | ObjectWire",
    description: "Cloudflare has opened its Dynamic Workers feature to all paid Workers users, offering a lightweight alternative to containers for executing AI-generated code, w",
    publishDate: "2026-03-29",
    modifiedDate: "2026-03-29",
    category: "Technology",
