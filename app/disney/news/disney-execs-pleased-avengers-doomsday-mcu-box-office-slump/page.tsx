...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/disney/news/disney-execs-pleased-avengers-doomsday-mcu-box-office-slump',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/disney/news/disney-execs-pleased-avengers-doomsday-mcu-box-office-slump',
    siteName: 'ObjectWire',
    authors: ['Alfansa'],
...
export default function AvengersDoomsdayDisneyBoxOfficePage() {
  return <WikiArticle slug="disney-news-disney-execs-pleased-avengers-doomsday-mcu-box-office-slump" />;
}
