...
export const metadata: Metadata = {
  title: 'Yamanaka Factors Can Reverse Cellular Aging Markers in',
  description:
    'Yamanaka factors OCT4 SOX2 KLF4 and c-MYC can reverse epigenetic aging in cells and mice, but no approved human rejuvenation therapy exists. Review of',
  keywords: [
  ...
  openGraph: {
    title: 'Yamanaka Factors Can Reverse Cellular Aging Markers | But',
    description:
  ...
  twitter: {
    ...
    title: 'Yamanaka Factors Reverse Cellular Aging | But Not Safely in',
    description:
