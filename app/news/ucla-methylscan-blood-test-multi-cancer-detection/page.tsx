...
export const metadata: Metadata = {
  title: 'UCLA MethylScan Blood Test | Multi-Cancer Detection Under $20',
  description: 'UCLA scientists developed MethylScan, a blood test that detects multiple cancers and liver diseases from a single sample for under $20 in sequencing costs, published in PNAS on April 6.',
  keywords: [
    'MethylScan',
  ...
  openGraph: {
    ...
    description: 'A new UCLA blood test called MethylScan detects multiple cancers and liver diseases from a single sample at 98% specificity, with sequencing costs under $20 per test.',
    type: 'article',
    url: ARTICLE_URL,
    siteName: 'ObjectWire',
  ...
  twitter: {
    ...
    title: 'UCLA MethylScan | Blood Test Detects Multiple Cancers for Under $20',
