...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/cuba/news/cuban-border-guards-kill-four-florida-speedboat-cayo-falcones',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/cuba/news/cuban-border-guards-kill-four-florida-speedboat-cayo-falcones',
    siteName: 'ObjectWire',
...
export default function CubaSpeedboatShootingPage() {
  return <WikiArticle slug="cuba-news-cuban-border-guards-kill-four-florida-speedboat-cayo-falcones" />;
}
