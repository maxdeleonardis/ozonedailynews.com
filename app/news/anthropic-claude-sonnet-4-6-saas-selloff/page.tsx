...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/news/anthropic-claude-sonnet-4-6-saas-selloff',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/news/anthropic-claude-sonnet-4-6-saas-selloff',
    siteName: 'ObjectWire',
...
export default function ClaudeSonnet46SaasPage() {
  return <WikiArticle slug="news-anthropic-claude-sonnet-4-6-saas-selloff" />;
}
