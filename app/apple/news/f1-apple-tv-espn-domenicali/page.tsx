...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/apple/news/f1-apple-tv-espn-domenicali',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/apple/news/f1-apple-tv-espn-domenicali',
    siteName: 'ObjectWire',
...
export default function F1AppleTVESPNPage() {
  return <WikiArticle slug="apple-news-f1-apple-tv-espn-domenicali" />;
}
