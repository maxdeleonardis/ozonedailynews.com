...
export const metadata: Metadata = {
  title: 'ARK Raiders | ObjectWire',
  description:
    'ARK Raiders is a free-to-play co-op extraction shooter from Nexon and Kömmling Interactive. Full profile: gameplay, lore, developer history, platforms, and release roadmap.',
  keywords: [
    'ARK Raiders game',
    'ARK Raiders Nexon',
    ...
    'ARK Raiders Kömmling Interactive',
  ...
  openGraph: {
    ...
    url: PAGE_URL,
    siteName: 'ObjectWire',
    images: [{ url: IMAGE_URL, width: 1200, height: 675, alt: 'ARK Raiders game art, co-op extraction shooter' }],
