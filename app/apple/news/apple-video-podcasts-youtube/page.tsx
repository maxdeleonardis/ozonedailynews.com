...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/apple/news/apple-video-podcasts-youtube',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/apple/news/apple-video-podcasts-youtube',
    siteName: 'ObjectWire',
...
export default function AppleVideoPodcastsPage() {
  return <WikiArticle slug="apple-news-apple-video-podcasts-youtube" />;
}
