...
export const metadata: Metadata = {
  ...
  description: 'Italy defeated the world-record-holding United States team in men\'s team pursuit speedskating at Milano Cortina 2026, claiming gold in a stunning',
  keywords: [
