...
export const metadata: Metadata = {
  title: 'Helion Energy | Sam Altman $1.65B Stake, Polaris Milestone',
  description: 'Helion Energy is Sam Altman\'s fusion startup valued at $5.4B. The Musk v. Altman trial revealed Altman holds a $1.65B stake while OpenAI signed a 5GW',
  keywords: [
    'Helion Energy',
  ...
  openGraph: {
    ...
    description: 'Full profile of Helion Energy: FRC fusion technology, the 150M degree Polaris milestone, and the Sam Altman conflict revealed during the Musk v. Altman',
    type: 'article',
    url: ARTICLE_URL,
    siteName: 'OzoneNews',
