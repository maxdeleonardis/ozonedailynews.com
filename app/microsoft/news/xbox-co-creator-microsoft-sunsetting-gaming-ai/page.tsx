...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/microsoft/news/xbox-co-creator-microsoft-sunsetting-gaming-ai',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/microsoft/news/xbox-co-creator-microsoft-sunsetting-gaming-ai',
    siteName: 'ObjectWire',
...
export default function XboxCoCreatorSunsetGamingPage() {
  return <WikiArticle slug="microsoft-news-xbox-co-creator-microsoft-sunsetting-gaming-ai" />;
}
