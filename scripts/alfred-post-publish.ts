#!/usr/bin/env tsx
// =============================================================================
// scripts/alfred-post-publish.ts
// =============================================================================
// One command that runs after every article write under the Alfred/Alfasa system.
//
...
//
// Usage:
//   npm run alfred:publish
//   npm run alfred:publish -- --skip-git       (sync + ping only, no commit)
//   npm run alfred:publish -- --skip-ping      (sync + git only, no sitemap ping)
//   npm run alfred:publish -- --dry-run        (preview only, no writes)
//
// Called automatically by the Alfred article pipeline after:
...
function gitPublish() {
  ...
  const message = [
    ...
    fileList,
    '',
    'Auto-generated by alfred-post-publish.ts',
...
function printSummary(added: number) {
  log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  log('  Alfred Post-Publish Complete');
  log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
...
main().catch(err => {
  console.error('\n❌  Alfred post-publish failed:', err);
  process.exit(1);
});
