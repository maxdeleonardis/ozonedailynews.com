...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/open-ai/altman-government-oversight-pentagon-deal' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/open-ai/altman-government-oversight-pentagon-deal',
    siteName: 'ObjectWire',
    authors: ['Alfanasa'],
...
export default function AltmanGovernmentOversightPage() {
  return <WikiArticle slug="open-ai-altman-government-oversight-pentagon-deal" />;
}
