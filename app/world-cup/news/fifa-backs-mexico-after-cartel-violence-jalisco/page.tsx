...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/world-cup/news/fifa-backs-mexico-after-cartel-violence-jalisco',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/world-cup/news/fifa-backs-mexico-after-cartel-violence-jalisco',
    siteName: 'ObjectWire',
    authors: ['Alfansa'],
...
export default function FifaMexicoCartelViolencePage() {
  return <WikiArticle slug="world-cup-news-fifa-backs-mexico-after-cartel-violence-jalisco" />;
}
