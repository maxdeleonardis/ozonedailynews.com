...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/microsoft/news/project-helix-xbox-pc-hybrid-console' },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/microsoft/news/project-helix-xbox-pc-hybrid-console',
    siteName: 'ObjectWire',
    authors: ['Alfanasa'],
...
export default function ProjectHelixPage() {
  return <WikiArticle slug="microsoft-news-project-helix-xbox-pc-hybrid-console" />;
}
