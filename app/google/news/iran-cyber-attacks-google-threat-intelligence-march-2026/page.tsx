...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/google/news/iran-cyber-attacks-google-threat-intelligence-march-2026',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/google/news/iran-cyber-attacks-google-threat-intelligence-march-2026',
    siteName: 'ObjectWire',
...
export default function IranCyberAttacksGoogleAlertPage() {
  return <WikiArticle slug="google-news-iran-cyber-attacks-google-threat-intelligence-march-2026" />;
}
