...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/trump/japan-36-billion-us-energy-critical-minerals',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/trump/japan-36-billion-us-energy-critical-minerals',
    siteName: 'ObjectWire',
...
export default function JapanUSEnergyPage() {
  return <WikiArticle slug="trump-japan-36-billion-us-energy-critical-minerals" />;
}
