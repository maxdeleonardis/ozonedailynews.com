...
export const metadata: Metadata = {
  ...
  description: 'John Deere agreed to pay $99 million and provide farmers with digital repair tools for 10 years, resolving a class-action lawsuit accusing the company of monopolizing tractor and harvester repairs.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Deere Settles Right-to-Repair Suit for $99M, 10 Years of Digital Tools',
