  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="https://twitter.com/objectwire" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://linkedin.com/company/objectwire" target="_blank" rel="noopener noreferrer"
          className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 hover:bg-[#0A66C2] hover:text-white text-gray-500 flex items-center justify-center transition-all duration-150"
          title="LinkedIn">
