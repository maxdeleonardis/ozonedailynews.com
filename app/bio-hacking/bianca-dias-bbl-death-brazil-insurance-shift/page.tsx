...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/bio-hacking/bianca-dias-bbl-death-brazil-insurance-shift',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/bio-hacking/bianca-dias-bbl-death-brazil-insurance-shift',
    siteName: 'ObjectWire',
...
export default function BiancaDiasBBLPage() {
  return <WikiArticle slug="bio-hacking-bianca-dias-bbl-death-brazil-insurance-shift" />;
}
