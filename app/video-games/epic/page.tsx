...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/epic',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/epic',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/video-games/unreal-engine-epic-games-film-automotive-architecture-2026.jpg'],
...
export default function UnrealEngineEpicPage() {
  return <WikiArticle slug="video-games-epic" />;
}
