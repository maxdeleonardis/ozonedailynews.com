...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/tech/minimax-maxclaw-openclaw-cloud-agent-clawbot-saas-february-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/tech/minimax-maxclaw-openclaw-cloud-agent-clawbot-saas-february-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/tech/minimax-maxclaw-openclaw-cloud-agent-clawbot-2026.jpg'],
...
export default function MiniMaxMaxClawOpenClawPage() {
  return <WikiArticle slug="tech-minimax-maxclaw-openclaw-cloud-agent-clawbot-saas-february-2026" />;
}
