...
const SLUG = '/influencer/bufalika';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    section: 'Influencer',
    tags: ['Bufalika', 'Influencer', 'OnlyFans', 'Instagram', 'Creator'],
...
export default function InfluencerBufalikaPage() {
  return <CreatorArticleDB slug="influencer-bufalika" />;
}
