...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/news/marathon-server-slam-steam-concurrent-players-peak-drop-march-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/news/marathon-server-slam-steam-concurrent-players-peak-drop-march-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/video-games/marathon-server-slam-steam-concurrent-players-peak-2026.jpg'],
...
export default function MarathonServerSlamPage() {
  return <WikiArticle slug="video-games-news-marathon-server-slam-steam-concurrent-players-peak-drop-march-2026" />;
}
