...
const SLUG = '/influencer/pokimane';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    tags: ['Pokimane', 'Influencer', 'Twitch', 'YouTube', 'Midnight'],
  ...
  return (
    ...
    >
      ...
      <CreatorSection heading="Pokimane 2026 | Life After Twitch Summary">
        ...
        <p>
          For more gaming and influencer coverage, see the{' '}
          <a href="/influencer" className="text-blue-600 hover:text-blue-800 underline">Influencer Hub</a> and the{' '}
          <a href="/influencer/valkyrae" className="text-blue-600 hover:text-blue-800 underline">Valkyrae profile</a>.
        </p>
      </CreatorSection>
