...
export const metadata: Metadata = {
  title:
    'AWS Temporarily Shuts Down UAE Availability Zone',
  description:
  ...
  openGraph: {
    title:
      'AWS Shuts Down UAE Data Center Zone After Objects Spark',
    description:
  ...
  twitter: {
    ...
    title:
      'AWS UAE Data Center Struck During Iranian Missile',
    description:
