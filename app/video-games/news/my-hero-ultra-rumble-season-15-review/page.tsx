...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/video-games/news/my-hero-ultra-rumble-season-15-review',
  },
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.objectwire.org/video-games/news/my-hero-ultra-rumble-season-15-review',
    siteName: 'ObjectWire',
...
export default function MHURSeason15ReviewPage() {
  return <WikiArticle slug="video-games-news-my-hero-ultra-rumble-season-15-review" />;
}
