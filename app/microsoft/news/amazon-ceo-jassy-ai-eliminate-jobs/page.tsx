...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.objectwire.org/microsoft/news/amazon-ceo-jassy-ai-eliminate-jobs' },
  openGraph: {
    ...
    type: 'article', url: 'https://www.objectwire.org/microsoft/news/amazon-ceo-jassy-ai-eliminate-jobs', siteName: 'ObjectWire',
...
export default function AmazonJassyAIJobsPage() {
  return <WikiArticle slug="microsoft-news-amazon-ceo-jassy-ai-eliminate-jobs" />;
}
