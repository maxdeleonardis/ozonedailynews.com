...
const AUTHORS = [
  {
    ...
    bio: 'Co-founder of OzoneNews, an independent nonprofit newsroom. Covers federal investigations, Congress, AI policy, and the intersection of politics and technology. Document-first reporter drawing on court filings, congressional records, and agency disclosures.',
  ...
  },
  {
    ...
    role: 'Co-Founder & Founding Writer',
    department: 'Science & Technology',
    location: 'Austin, TX',
    bio: 'Co-founder and founding writer at OzoneNews. NC State journalism graduate covering biotechnology, CRISPR, medical research, AI hardware, gaming, and emerging technology. Primary writer on science and tech coverage.',
  ...
  },
  {
    ...
    bio: 'Finance & Markets Reporter and Anime & Gaming Editor at OzoneNews. Covers payments, fintech, equity markets, crypto infrastructure, My Hero Academia, and the business of gaming culture from New York.',
  ...
  },
  {
    ...
    initials: 'JB',
    name: 'Jack Brennan',
    role: 'Creator & Influencer Reporter',
    department: 'Creator Economy',
    location: 'New York, NY',
    bio: 'Creator & Influencer Reporter covering digital creator economics, platform policy, TikTok, Instagram, and the business of social media. Produces verified biographical profiles of digital creators with sourced follower metrics and career histories.',
    beats: ['Creator Economy', 'TikTok', 'Instagram', 'YouTube', 'Platform Policy', 'Social Commerce'],
