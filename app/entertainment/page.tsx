...
export default async function Page() {
  ...
  const articles = all
    .filter((e) => {
      const slugMatch = e.slug.startsWith('/entertainment/');
      const catMatch = ['Entertainment', 'entertainment'].some(
      ...
      <header className="border-b-2 border-black bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          <nav className="text-xs text-gray-500 mb-4">
            ...
            <span className="text-black font-semibold">Entertainment</span>
          </nav>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 text-base sm:text-lg max-w-2xl">
                Film, television, streaming platforms, and pop culture.
              </p>
            </div>
          </div>
        </div>
