...
import { redirects as siteRedirects } from "./config/redirects";
...
const nextConfig: NextConfig = {
  ...
  // ==========================================================================
  // All redirects live in config/redirects.ts
  // To ADD a redirect:    add an entry to config/redirects.ts
  // To REMOVE a redirect: delete the entry (restores the page when ready)
