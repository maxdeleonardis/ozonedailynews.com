...
export const metadata: Metadata = {
  title: 'Crypto News | Bitcoin, Ethereum & Web3 2026',
  description: 'Crypto news covering Bitcoin, Ethereum, stablecoins, DeFi, and Web3 from ObjectWire.',
...
export default async function Page() {
  ...
  const articles = all
    .filter((e) => {
      const slugMatch = e.slug.startsWith('/crypto/');
      const catMatch = ['Crypto', 'crypto'].some(
      ...
      <header className="border-b-2 border-black bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          <nav className="text-xs text-gray-500 mb-4">
            ...
            <span className="text-black font-semibold">Crypto</span>
          </nav>
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 text-base sm:text-lg max-w-2xl">
                Bitcoin, Ethereum, stablecoins, DeFi, and Web3 developments.
              </p>
            </div>
          </div>
        </div>
              ...
              {articles.map((article) => (
                ...
                >
                  {article.imageUrl ? (
                    ...
                    <div className="w-full aspect-[16/9] bg-amber-50 border-amber-200 border-b flex items-center justify-center shrink-0">
                      <span className="text-amber-600 text-3xl font-black opacity-30">OW</span>
                    </div>
                  )}
