...
export const metadata: Metadata = {
  ...
  description: 'Ubisoft company profile: the French gaming giant behind Assassin\'s Creed, Far Cry, and Rainbow Six. 2026 Creative Houses restructure, Tencent investment, financials, and full game roadmap.',
  keywords: [
    'Ubisoft',
