...
export const metadata: Metadata = {
  ...
  description:
    "PayPal announced on March 18, 2026, that its dollar-backed stablecoin PayPal USD (PYUSD) is now available in 70 markets across Asia-Pacific, Europe, Latin",
  keywords: [
  ...
  openGraph: {
    title: "PayPal Expands PYUSD Stablecoin to 70 Markets Worldwide",
    description:
      "PayPal USD now available in 70 markets across four continents after launching exclusively in the U.S. and U.K. New regions include Colombia, Singapore,",
    type: 'article',
    url: FULL_URL,
    siteName: 'ObjectWire',
  ...
  twitter: {
    ...
    title: "PayPal's PYUSD Stablecoin Goes Global | 70 Markets Across 4 Continents",
    description:
      "PayPal USD just expanded from 2 countries to 70 markets. Colombia, Singapore, Panama, Guatemala, Peru and dozens more now have access to the dollar-backed",
  },
  other: {
    news_keywords:
