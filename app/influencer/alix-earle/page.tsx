...
const SLUG = '/influencer/alix-earle';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    tags: ['Alix Earle', 'Influencer', 'TikTok', 'GRWM', 'Florida'],
    ...
    <CreatorArticle
      schema={{
        ...
        keywords: [
          ...
          'University of Miami influencer', 'Alix Earle 2026',
        ],
      }}
      breadcrumbs={[
      ...
      hero={{
        ...
        name: 'Alix Earle',
        subtitle: 'TikTok Creator, GRWM Influencer, Brand Partner',
        description:
      ...
      sidebar={{
        ...
        relatedLinks: [
          ...
          { href: '/influencer/charli-damelio', label: 'Charli D\'Amelio Profile' },
      ...
      tags={['Alix Earle', 'TikTok', 'GRWM', 'Influencer', 'Florida', 'Beauty Creator']}
    >
      ...
      <CreatorCalloutBox
        ...
        items={[
          ...
          { label: 'Tarte Cosmetics', detail: 'Coachella trip influencer group; ongoing partnership' },
      ...
      <CreatorSection heading="Alix Earle 2026 | Creator Profile Summary">
        ...
        <p>
          ...
          <a href="/influencer/charli-damelio" className="text-blue-600 hover:text-blue-800 underline">Charli D'Amelio profile</a>.
        </p>
      </CreatorSection>
