...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.objectwire.org/bio-hacking/eledon-pharmaceuticals-eldn-cd40l-tegoprubart-transplant-2026',
  },
  openGraph: {
    title:
    ...
    type: 'article',
    url: 'https://www.objectwire.org/bio-hacking/eledon-pharmaceuticals-eldn-cd40l-tegoprubart-transplant-2026',
    siteName: 'ObjectWire',
    images: ['https://www.objectwire.org/bio-hacking/eledon-pharmaceuticals-tegoprubart-cd40l.jpg'],
...
export default function EledonPharmaceuticalsPage() {
  return <WikiArticle slug="bio-hacking-eledon-pharmaceuticals-eldn-cd40l-tegoprubart-transplant-2026" />;
}
