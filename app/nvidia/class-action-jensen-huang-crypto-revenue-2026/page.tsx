...
export const metadata: Metadata = {
  title: 'NVIDIA Class Action Certified | Jensen Huang Crypto Revenue',
  description:
  ...
  openGraph: {
    type: 'article',
    title: 'Federal Judge Certifies Class Action Against NVIDIA and',
    description:
  ...
  twitter: {
    ...
    title: 'NVIDIA Class Action Certified | Jensen Huang Crypto Fraud',
    description:
